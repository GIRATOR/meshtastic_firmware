...
#define str_loramenu_lora_power         "Потужність"
#define str_loramenu_lora_dutycycle     "Роб. цикл"
#define str_loramenu_lora_region        "ЛОРА регіон"
#define str_loramenu_powerauto          "Макс. дозв."
#define str_loramenu_txpower            "%lu дБм"
...
#define str_dbgrndr_txpower             "Пот.: %luдБм*%lu%%"
