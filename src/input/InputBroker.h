...
enum input_broker_event {
    ...
    // redefine this annoing shit so it never triggers
    #define INPUT_BROKER_MSG_BRIGHTNESS_UP 0x0A
    #define INPUT_BROKER_MSG_BRIGHTNESS_DOWN 0x0B
    #define INPUT_BROKER_MSG_REBOOT 0x0C
    #define INPUT_BROKER_MSG_MUTE_TOGGLE 0x0D
    #define INPUT_BROKER_MSG_FN_SYMBOL_ON 0x0E
    #define INPUT_BROKER_MSG_FN_SYMBOL_OFF 0x0F
    #define INPUT_BROKER_MSG_BLUETOOTH_TOGGLE 0x1A
    #define INPUT_BROKER_MSG_TAB 0x1B
    #define INPUT_BROKER_MSG_EMOTE_LIST 0x1C
#else
