...
// Two supported RGB LED currently
    ...
    defined(USE_SPISSD1306) || defined(USE_ST7796) || defined(HACKADAY_COMMUNICATOR)
        ...
        screen = new graphics::Screen(ScanI2C::ADDRESS_NONE, meshtastic_Config_DisplayConfig_OledType_OLED_AUTO, GEOMETRY_RAWMODE);
#elif defined(ARCH_PORTDUINO)
...
#if defined(ST7701_CS) || defined(ST7735_CS) || defined(USE_EINK) || defined(ILI9341_DRIVER) || defined(ILI9342_DRIVER) ||       \
    defined(ST7789_CS) || defined(HX8357_CS) || defined(USE_ST7789) || defined(ILI9488_CS) || defined(ST7796_CS) ||              \
    defined(USE_ST7796) || defined(USE_SPISSD1306) || defined(HACKADAY_COMMUNICATOR) || defined(USE_PCF8812)
    if (screen){
        screen->setup();
    }
#elif defined(ARCH_PORTDUINO)
